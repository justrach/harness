# Native browser tabs for Harness: system-webview v1
...
Harness baseline: `8de07ee6d783a37c2cac39a259ba896d704c40e8` (latest fetched `origin/main`). This worktree was clean and fast-forwarded from `6b2ea31f`; the separate local `main` worktree was not modified.
...
### 1. Prove native embedding in Harness's GPUI fork
