...
A standalone reproduction isolates the mechanism without Harness, a window,
...
Harness's rendering uses these command types. Reducing unnecessary submissions
...
HARNESS_PROFILE_PROMPT='Replay fixture.' HARNESS_PROFILE_IDLE_MS=10000 \
HARNESS_FRAME_STATS=0 node scripts/resource-profile.mjs \
  /path/to/immutable/harness /tmp/fresh-replay-profile claude-code
```
