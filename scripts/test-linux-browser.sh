...
export HARNESS_BROWSER_NATIVE_POINTER=1
...
record_fixture x11
export WAYLAND_DISPLAY=harness-browser-test GDK_BACKEND=wayland
...
export HARNESS_BROWSER_CAPTURE_WINDOW="$(xdotool search --class weston | head -1)"
record_fixture wayland "$HARNESS_BROWSER_CAPTURE_WINDOW"
