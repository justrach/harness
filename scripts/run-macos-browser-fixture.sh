...
BINARY="$1"
shift
BUNDLE="$(mktemp -d "${TMPDIR:-/tmp}/harness-browser-fixture.XXXXXX")/Fixture.app"
...
/usr/libexec/PlistBuddy -c 'Set :CFBundleIdentifier sh.harness.browser-fixture' "$BUNDLE/Contents/Info.plist"
