...
final class DemoDataset {
    ...
    static let fileTree: [String: [String]] = [
        ...
        "/Users/dev/Projects": ["harness", "dotfiles", "blog", "playground"],
        "/Users/dev/Projects/harness": ["apps", "crates", "docs", "edge"],
    ...
    private static let repoNames: Set<String> = ["harness", "dotfiles", "blog", "playground", "edge", "landing"]
    ...
    func listRefs(spacePath: String) -> [RepoRef] {
        ...
        let seeded: [RepoRef]
        if spacePath.contains("harness") {
            seeded = [
                RepoRef(name: "main", current: true, worktreePath: nil),
                RepoRef(name: "veil-fade", current: false,
                        worktreePath: "/Users/dev/.harness/worktrees/harness-veil-fade"),
    ...
    func createWorktree(spacePath: String, base: String) -> String {
        ...
        let path = "/Users/dev/.harness/worktrees/\((spacePath as NSString).lastPathComponent)-\(slug)"
        ...
        case "chat-veil":
            return [
                ...
                MessageEntry(id: "m2", role: .assistant, parts: [
                    ...
                    .tool(id: "tool2", call: RenderToolCall(tag: "editFile", fields: ["path": "Harness/Transcript/Veil.swift"]), isError: false, resolved: true),
                    .tool(id: "tool3", call: RenderToolCall(tag: "exec", fields: ["command": "xcodebuild -scheme Harness build"]), isError: false, resolved: true),
                    .text(id: "t1", text: """
