...
//!
//! Port of harness's `packages/session-doc`. The schema SHAPE (container names, part maps with
...
//!
//! Load-bearing invariant (measured in harness, `oplog-shape.test.ts`): message parts are a
