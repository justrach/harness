...
//!
//! ```sh
//! HARNESS_EDGE_WS=ws://127.0.0.1:27640 cargo test -p harness-sync --test registry_edge -- --ignored
//! ```
...
fn edge_url(org: &str, user: &str) -> String {
    let base = std::env::var("HARNESS_EDGE_WS")
        .expect("set HARNESS_EDGE_WS to the edge origin, e.g. ws://127.0.0.1:27640");
...
#[tokio::test]
#[ignore = "requires a live edge: set HARNESS_EDGE_WS (e.g. ws://127.0.0.1:27640)"]
