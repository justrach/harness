...
//! (`harness_doc::apply_op`). Test infrastructure only (`mock-server` feature):
//! harness-sync's client tests and harness-engine's two-engine integration tests
...
use harness_doc::{RegistryRow, RowOp, apply_op};
