...
//! [`harness_doc::RegistryDoc`] under a lock. Wire frames are JSON text —
...
use harness_doc::{PendingBatch, RegistryDoc, RegistryRow, StateOutcome};
