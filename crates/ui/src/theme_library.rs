...
use gpui::{App, Global};
use harness_theme::vscode::SourceCompilation;
use harness_theme::{
...
fn reconcile_and_refresh(cx: &mut App) {
    ...
    for appearance_kind in [Appearance::Light, Appearance::Dark] {
        let model = if appearance_kind.is_light() {
            harness_theme::Appearance::Light
        } else {
            harness_theme::Appearance::Dark
        };
...
mod tests {
    ...
    fn failed_persistence_leaves_library_state_unchanged() {
        ...
        next.entries.push(CustomThemeEntry {
            ...
            source: harness_theme::CustomThemeSource::ImportedSnapshot {
                imported_from: None,
            },
            family: harness_theme::ThemeFamily {
                id: "unpersisted".into(),
                name: "Unpersisted".into(),
                variants: Vec::new(),
            },
            ...
            status: harness_theme::CustomThemeStatus::Ready,
        });
