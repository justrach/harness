//! Syntax-highlighting contracts shared by Harness's desktop surfaces.
//!
...
fn rust_configuration() -> Result<HighlightConfiguration, HighlightError> {
    ...
    // `constant.builtin`. Harness preserves those structural roles separately.
