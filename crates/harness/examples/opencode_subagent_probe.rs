...
//!
//!     cargo run -p harness-adapters --example opencode_subagent_probe -- /tmp/oc-probe/workspace
//!
...
use harness_proto::{AgentEvent, RunRequest, SandboxLevel, UserInputAnswer};
